    ...
    ({ item }) => {
      return (
        <View style={styles.focusedCard}>
          ...
          <Text style={styles.focusedCardText}>{item.name}</Text>
          <LinearGradient
  ...
  return (
    <View style={styles.container}>
      <CustomHeader
        ...
        renderLeft={<Image source={IMAGES.nagori} style={styles.appIcon} />}
        renderRight={
...
const styles = StyleSheet.create({
  ...
  categoryText: {
    ...
    textAlignVertical: 'center', // Android-safe, iOS ignore karega
  },
